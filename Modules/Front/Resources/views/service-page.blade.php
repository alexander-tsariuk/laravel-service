...
@section('content')
    ...
    <section class="portfolio_section mb-140">
        <div class="container-fluid">
            ...
            <div class="container-fluid" id="project-container-fluid">
                @if(isset($projects) && !empty($projects))
                    <div id="projects-container" class="row">
                        @foreach($projects as $project)
                            <div class="col-4 flex-fill bd-highlight  py-0 px-0 mx-0 my-0">
                                <figure class="portfolio_thumb fadeInUp" >
                                    <a href="{{config()->get('app.defaultLocale') != config()->get('app.locale') ? "/".config()->get('app.locale') : null}}{{ route('front.render.page', ['prefix' => $project->prefix], false) }}">
                                        <img src="/storage{{ $project->image }}" alt="{{ $project->translation->name }}" class="img-responsive">
                                    </a>
            ...
            @if(isset($projects) && !empty($projects) && count($projects) == 9)
