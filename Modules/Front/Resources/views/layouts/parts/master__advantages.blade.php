<section class="service_section section-pdding-bottom">
    <div class="container">
        ...
        <div class="service_container">
            <div class="row">
                <div class="col-12">
                    <div class="services_gallery d-md-flex justify-content-between align-items-center">
                        <div class="services_list">
                            <div class="single_services flex-md-row-reverse text-md-end d-flex wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s" style="visibility: visible; animation-duration: 1.1s; animation-delay: 0.1s; animation-name: fadeInUp;">
