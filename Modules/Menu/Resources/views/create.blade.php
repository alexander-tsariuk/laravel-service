...
@section('content')
    <div class="row">
        <div class="col-12">
            <form id="editItem" action="{{ route('dashboard.menu.store') }}" method="POST">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="custom-select form-control-border {{ $errors->has('name') ? 'is-invalid' : '' }}" name="name" required>
